...
Linked [here](continuedev_config.yaml) is the example config.yaml that I have used for the extension that links to my llama.cpp endpoint and has similar model configuration that the web UI uses
